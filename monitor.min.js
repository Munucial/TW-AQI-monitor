...
}), app.get("/data", function(t, e) {var datajson = jsonfile.readFileSync('./data/data.json'); res.json(datajson);}), app.get("/info", function(t, e) {res.status(200).send("<h1>App info:</h1><h2>Started at: "+starttime+"</h2><h2>Data catched (per hour): ")}), app.listen(process.env.PORT || 5118);
